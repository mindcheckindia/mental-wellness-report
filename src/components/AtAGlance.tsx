...
import {
    DepressionIcon, AngerIcon, ManiaIcon, AnxietyIcon, SomaticIcon, SuicideIcon, PsychosisIcon, SleepIcon, MemoryIcon, RepetitiveIcon, DissociationIcon, PersonalityIcon
} from './icons';

const domainIcons: { [key: string]: React.FC<React.SVGProps<SVGSVGElement>> } = {
